...
const questions = [
 ...
 ['How can I follow the project?', 'You can follow the Basic Mails repository on GitHub and check the build notes here. The waiting-list page lets you request a launch notification when sign-ups open. Confirm your email to complete your registration.'],
];
